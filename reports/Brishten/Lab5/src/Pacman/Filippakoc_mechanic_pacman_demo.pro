...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../level/build-fontPluginInterface2-Desktop_Qt_5_15_2_MinGW_32_bit-Debug/release/ -lfontPluginInterface2
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../level/build-fontPluginInterface2-Desktop_Qt_5_15_2_MinGW_32_bit-Debug/debug/ -lfontPluginInterface2
else:unix: LIBS += -L$$PWD/../level/build-fontPluginInterface2-Desktop_Qt_5_15_2_MinGW_32_bit-Debug/ -lfontPluginInterface2

INCLUDEPATH += $$PWD/../level/fontPluginInterface
DEPENDPATH += $$PWD/../level/fontPluginInterface
