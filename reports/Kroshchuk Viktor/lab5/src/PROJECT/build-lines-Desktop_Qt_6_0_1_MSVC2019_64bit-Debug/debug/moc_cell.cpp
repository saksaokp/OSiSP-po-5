...
QT_MOC_LITERAL(5, 10), // "wasPressed"
QT_MOC_LITERAL(16, 0), // ""
QT_MOC_LITERAL(17, 11), // "MatrixPoint"
QT_MOC_LITERAL(29, 5), // "place"
QT_MOC_LITERAL(35, 10), // "idiotClick"
QT_MOC_LITERAL(46, 5) // "zrtik"

    },
    "Cell\0wasPressed\0\0MatrixPoint\0place\0"
    "idiotClick\0zrtik"
};
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->wasPressed((*reinterpret_cast< MatrixPoint(*)>(_a[1]))); break;
        case 1: _t->idiotClick((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Cell::*)(MatrixPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::wasPressed)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<MatrixPoint, std::false_type>
...
// SIGNAL 0
void Cell::wasPressed(MatrixPoint _t1)
{
