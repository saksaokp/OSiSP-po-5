...
QT_MOC_LITERAL(7, 9), // "time_load"
QT_MOC_LITERAL(17, 0), // ""
QT_MOC_LITERAL(18, 11), // "load_update"
QT_MOC_LITERAL(30, 10), // "load_video"
QT_MOC_LITERAL(41, 9), // "sockReady"
QT_MOC_LITERAL(51, 8), // "sockDisc"
QT_MOC_LITERAL(60, 3), // "run"
QT_MOC_LITERAL(64, 11) // "share_video"

    },
    "Thread\0time_load\0\0load_update\0load_video\0"
    "sockReady\0sockDisc\0run\0share_video"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->time_load((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->load_update((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->load_video((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->sockReady(); break;
        case 4: _t->sockDisc(); break;
        case 5: _t->run(); break;
        case 6: _t->share_video(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::time_load)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Thread::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::load_update)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Thread::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::load_video)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void Thread::load_update(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void Thread::load_video(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
